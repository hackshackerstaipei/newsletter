...
- 去年年底，紐時資料新聞欄位The Upshot的編輯Josh Katz推出了一個有趣的文化專題。他比對Facebook用戶的郵遞區號、以及該用戶對電視劇的喜好（以是否"Like"電視劇的粉專來判斷），透過圖表來分析美國大眾文化的地域差別。 

 ![電視劇的喜好分布](/img/2017/drama-divided.png?raw=true "drama divided.")

 受到Josh作品的啟發，操作Facebook廣告行銷的Polygraph媒體，旗下視覺化內容團隊The Pudding也在奧斯卡季節做了一個類似於紐時的作品。不拿他們熟悉的Facebook數據，而是採取Youtube的資料，透過比對用戶地理訊息、以及是否看過入圍電影的官方預告，發現從西岸到東岸，觀眾對入圍影片的喜好大不相同。

 ![奧斯卡提名影片的喜好分布](/img/2017/geography-of-nominees.png?raw=true "geography of oscar nominees.")
 
 把難以量化的文化喜好，透過社群平台的數據，挖掘有趣的故事。台灣有什麼適合的選題嗎？
